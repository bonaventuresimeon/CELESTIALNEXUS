...
## Responsive review — 17 September 2026
Added min-width safeguards for grid children, wrapping badges/headings, scrollable tables, dynamic-height mobile navigation/dialogs, 44px navigation touch targets, 16px mobile form inputs, tablet grids and narrow-phone spacing. Browser checks rendered six pages (home, platform, evidence, contact, docs and pricing) at iframe viewport widths 320, 390, 768, 1024, 1440 and 2560 pixels: all 36 cases had document scrollWidth equal to clientWidth, without page-level horizontal overflow. Mobile navigation opened successfully. Mobile/tablet layouts were visually inspected. These are Chromium responsive-layout checks, not physical-device or Safari/Firefox certification.
